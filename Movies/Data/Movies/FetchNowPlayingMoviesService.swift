//
//  FetchNowPlayingMoviesService.swift
//  Movies
//
...
struct FetchNowPlayingMoviesService: FetchMoviesService {
    ...
    func fetchMovies(isInitialFetch: Bool) async throws -> [Movie] {
        ...
        let request = try MoviesProvider.makeNowPlayingRequest(page: page)
